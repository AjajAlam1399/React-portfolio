...
export default function Home() {
  return (
    <div name="Home" className=" w-full h-screen flex flex-col items-center bg-gradient-to-b from-black to-slate-800 justify-center mb-0">
      <div className="md:space-x-12 max-w-screen-lg px-10 lg:px-0 mx-auto flex justify-center  items-center h-full text-white flex-col md:flex-row">
        <div className="">
          <h1 className="md:text-6xl  text-xl font-normal pt-14 md:pt-0">I'm a Full Stack Developer </h1>
        ...
        <div className="sm:w-72 mt-4 md:mt-0 h-80 md:h-80  md:w-72 hover:">
            <img className="rounded-xl w-full h-full md:w-full"  src={Hero} alt="My profile  " />
        </div>
      </div>
    </div>
  );
